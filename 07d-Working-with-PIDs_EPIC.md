...
This lecture takes you through the steps to create and administer PIDs employing the HTTP restful API provided by EPIC.
The EPIC API runs on top of a handle server and provides additional functionality.
